...
void MostVisitedSites::OnMostVisitedURLsAvailable(
  ...
  LOG(INFO) << "[NextKiwi] MostVisitedSites::OnMostVisitedURLsAvailable - Step 2: " << num_tiles;
  LOG(INFO) << "[NextKiwi] MostVisitedSites::OnMostVisitedURLsAvailable - Step 2a: " << visited_list.size();
  LOG(INFO) << "[NextKiwi] MostVisitedSites::OnMostVisitedURLsAvailable - Step 2b: " << GetMaxNumSites();
...
void MostVisitedSites::SaveTilesAndNotify(
  ...
  LOG(INFO) << "[NextKiwi] MostVisitedSites::SaveTilesAndNotify - Step 1";
  ...
  LOG(INFO) << "[NextKiwi] MostVisitedSites::SaveTilesAndNotify - Step 2";

  if (observers_.empty())
    return;
  sections[SectionType::PERSONALIZED] = *current_tiles_;
  LOG(INFO) << "[NextKiwi] MostVisitedSites::SaveTilesAndNotify - Step 3";
